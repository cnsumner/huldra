...
class KnowledgeBase extends _$KnowledgeBase {
  ...
  Future<void> updateWord(Word word) => into(words).insertOnConflictUpdate(word);
  ...
  Future<void> updateMetadata(MetaData markovData) => into(meta).insertOnConflictUpdate(markovData);
